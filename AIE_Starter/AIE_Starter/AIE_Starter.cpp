...
int main(int argc, char* argv[])
{
	...
	asciiMap.push_back("0110000111000000000101110");     // row 4
	asciiMap.push_back("0111111111011111111101110");     // row 5
	asciiMap.push_back("0111111111011111111101110");     // row 6
	asciiMap.push_back("0111111111111111111101110");     // row 7
	asciiMap.push_back("0111111111000001110001110");     // row 8
	asciiMap.push_back("0111111111000001110001110");     // row 9
	asciiMap.push_back("0111111111111111111101110");     // row 10
	asciiMap.push_back("0111111110101111111101110");     // row 11
	asciiMap.push_back("0110111110101111111101110");     // row 12
	asciiMap.push_back("0110111110100001110001110");     // row 13
	asciiMap.push_back("0110000000100001110001110");     // row 14
	asciiMap.push_back("0110111111100011111111110");     // row 15
